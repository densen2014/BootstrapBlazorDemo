...
public class Foo
{
    ...
    [AutoGenerateColumn(Order = 999, Filterable = true, Searchable = true, Group = "基本")]
    [Display(Name = "姓名")]
    ...
    ///
    /// </summary>
    [AutoGenerateColumn(Order = 1, FormatString = "yyyy-MM-dd", Width = 180, Group = "扩展")]
    [Display(Name = "日期")]
    ...
    [Display(Name = "地址")]
    [Required(ErrorMessage = "{0}不能为空")]
    [AutoGenerateColumn(Order = 20, Filterable = true, Searchable = true, Group = "基本")]
    ...
    [Display(Name = "数量")]
    [Required]
    [AutoGenerateColumn(Order = 40, Sortable = true, Searchable = true, Group = "扩展")]
    ...
    [Display(Name = "学历")]
    [AutoGenerateColumn(Order = 1, Group = "基本")]
    ...
    [Display(Name = "爱好")]
    [AutoGenerateColumn(Order = 70, Searchable = true, Group = "扩展")]
    ...
    /// </summary>
    /// <returns></returns>
    public static List<Foo> GenerateFoo( int count = 5) => Enumerable.Range(1, count).Select(i => new Foo()
    {
        Id = i,
        Name =   $"张三 {i:d4}",
        DateTime = System.DateTime.Now.AddDays(i - 1),
        Address =  $"地址 {random.Next(1000, 2000)}",
        Count = random.Next(1, 100),
        Complete = random.Next(1, 100) > 50,
        Education = random.Next(1, 100) > 50 ? EnumEducation.Primary : EnumEducation.Middel
    }).ToList();
